    ...
    st.markdown(
        ...
        <style>
            ...
            .result-card {
                ...
                box-shadow: 0 12px 32px rgba(13,59,102,0.10);
                padding: 22px;
                margin-top: 1.25rem;
                width: 100%;
...
def render_result(result):
    ...
    with _render_card_start():
        ...
        if result.get("diagnosis"):
            ...
            html_lines.append(f"<p style='margin-top:0.1rem; margin-bottom:0.35rem; font-weight:700; color:#28a745;'>{diagnosis}</p>")
